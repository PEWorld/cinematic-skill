...
### W3 — Правило deadpan
Невозможное снимается так, будто это обычная хроника: CCTV, гейм-движок, home video, news footage, phone snap. **Камера не удивляется — удивляется зритель.** Никаких «эпичных» ракурсов вокруг чуда, никакого подчёркивания. Робот за крэпс-столом снят так же скучно, как остальные игроки. Deadpan — то, что отличает «фильм-вселенную» от «AI-фэнтези-каши».
